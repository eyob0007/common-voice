...
not-found-page-header = ვერ მოიძებნა
...
player-play-pause-shortcut-name = გაშვება / შეჩერება
...
player-skip-backward-shortcut-name = უკუსვლა
...
player-skip-forward-shortcut-name = წინსვლა

## Transcription Player - Aria Labels

# Play button accessibility/aria label
player-play-button-aria-label = ხმის გაშვება
# Pause button accessibility/aria label
player-pause-button-aria-label = ხმის შეჩერება
...
player-speed-normal-aria-label = დაკვრის საშუალო სიჩქარე
