...
record-player-header = Grave a súa resposta
...
error-recording-too-short = A gravación é demasiado curta. A duración mínima é de { $minDurationSeconds } segundos.
error-recording-too-long = A gravación é demasiado longa. A duración máxima é de { $maxDurationMinutes } minutos.
