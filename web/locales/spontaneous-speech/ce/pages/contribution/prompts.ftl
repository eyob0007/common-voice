...
error-uploading-response = Жоп дӀадахьийта ца дели
error-empty-audio = ДӀаяздарехь гӀалатдели. Аудио чохь хӀумма а яц. Юха хьажа
error-platform-webview = Аз дӀаяздан браузеран кхин верси оьшу. Кхин браузер схьаелла
error-recording-too-short-seconds = ДӀаяздинарг чӀогӀа доца ду. лаххара хан{ $minDurationSeconds } секунд хила еза
error-recording-too-long-minutes = ДӀаяздинарг чӀогӀа деха ду. лаккхара хан{ $minDurationSeconds } минот хила еза
cannot-play-audio = Аз лакха ца дели. Юха хьажа
prompt-submitted-success = Жоп кхиамца дӀахьажийна
prompt-response-deleted-success = Жоп кхиамца дӀадаьккхина
# For the button to delete a response to a prompt
delete = ДIайаккха
# For the disabled button on a prompt that indicates a prompt is already submitted
submitted = ДӀадахьийтина
# For the button on the Respond to prompts page which can be used to submit all responses at once
submit-all-button = Дерриге дӀадахьийта
