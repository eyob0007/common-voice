...
write = sabima
write-instruction = Pahimi <icon></icon> yɛltɔɣili din ka ŋun su li
...
sentence-input-placeholder = Kpɛhimi a yɛltɔɣili din ka ŋun su li maa kpe
...
new-sentence-rule-4 = Zaŋmi bachinima yiɣisibu din niŋ dede mini bibahira n-tum tuma
new-sentence-rule-5 = Nambanima mini bachikɔba din gahim kani
...
guidelines = Sodolisi
contact-us = Bɔlimi ti
add-sentence-success = Yɛltɔɣ' gaŋa deeya
...
agriculture_food = Pukparigu mini bindira
# Sentence Domain dropdown option
automotive_transport = Loorinima
# Sentence Domain dropdown option
finance = Laɣiri
# Sentence Domain dropdown option
service_retail = Kɔhimma ni damma
# Sentence Domain dropdown option
general = Din kam pahi
# Sentence Domain dropdown option
healthcare = Alaafee bɔmma
# Sentence Domain dropdown option
history_law_government = Yɛlikura, fukumsi zalisi mini gɔmnanti
# Sentence Domain dropdown option
language_fundamentals = Balli yɛl' kpɛma (nambanima, bachikɔba, liɣiri)
# Sentence Domain dropdown option
media_entertainment = Pɔhim zuɣu mini diɛma ni yiɣijam
# Sentence Domain dropdown option
nature_environment = Tingbani nama tiɛri
# Sentence Domain dropdown option
news_current_affairs = Lahibali mini yɛli shɛŋa din na niŋda
# Sentence Domain dropdown option
technology_robotics = Tabiibi baŋsim mini Rɔbɔɔtinima baŋsim
sentence-variant-select-label = Yɛltɔɣ' balibu
...
sc-bulk-upload-instruction = Vuumi a gbaŋ maa kana kpe bee <uploadButton>ka a dihi n-zaŋ pahi</uploadButton>
sc-bulk-upload-instruction-drop = Zaŋmi gbaŋ m-bahi kpe ka di pahi
bulk-upload-additional-information = A yi mali lahibali zaŋ kpa gbaŋ ŋɔ polo, nyin dimi suɣulo ka sabi ti <emailFragment>commonvoice@mozilla.com</emailFragment>
template-file-additional-information = A yi mali lahibali zaŋ kpa gbaŋ ŋɔ polo ka bɔri ni a zaŋ m-pahi ti, ka di ka ti gbaŋ maa ni, nyin dimi suɣulo ka sabi ti <emailFragment>commonvoice@mozilla.com</emailFragment>
try-upload-again = Mɔmi n-voogi a gbaŋ maa na kpe.
try-upload-again-md = Mɔmi ni a zaŋ li m-pahi yaha
select-file = Piimi gbaŋ
select-file-mobile = Piimi gban' shɛli a ni bɔri ni a zaŋ m-pahi
accepted-files = Di ni deeri gban shɛŋa: .tsv ko
minimum-sentences = Yɛltɔɣa yi kuli bi galisi gbaŋ ni di tu ni di paai 1000
maximum-file-size = Gbaŋ barilim tariga 25MB
what-needs-to-be-in-file = Bɔ n-tu ni di be n gbaŋ/faali puuni?
what-needs-to-be-in-file-explanation = Dimi suɣulo ka yuli ti <templateFileLink> sodologu gbaŋ ŋɔ </templateFileLink>. A yɛltɔɣa maa bi simdi ni di nyɛ so dini (CC0 bee ka di nyɛ ŋun yɛn zaŋ li m-pahi maa ni mali soli ni o tooi zaŋ li m-pahi) di tu ka di ne, ka doli yɛltɔɣa biɛhigu ka di karimbu be asama. Yɛltɔɣa din zaŋ pahi ni tooi di saha kamani sɛkɛnsi 10-15 n-yooi, amaa miri ka a pahi nambanima, bachinamdimaŋa ni bachikɔba din gahim.
upload-progress-text = Pahibu na chanimi....
sc-bulk-submit-confirm = N ti saɣiya ni yɛltɔɣa ŋɔ pala <wikipediaLink> so dini <wikipediaLink> ka m mali soli ni n tooi zaŋ ŋa m-pahi.
bulk-upload-success-toast = Yɛltɔɣa din galisi zaŋ pahi
bulk-upload-failed-toast = Zan pahi maa bi niŋ, dimi suɣulo ka labi niŋ
bulk-submission-success-header = Ti paɣiya a ni zaŋ pahibu din galisi n-ti maa
bulk-submission-success-subheader = A nyɛla ŋun sɔŋdi Common Voice ni di pali di dabisili puuni bachinima nia!
upload-more-btn-text = A bɔri ni a pahimi yɛltɔɣa pam?
