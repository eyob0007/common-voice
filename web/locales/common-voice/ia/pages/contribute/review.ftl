...
sc-review-form-keyboard-usage-custom = Tu pote etiam usar le claves accelerator: { sc-review-form-button-approve-shortcut } pro approbar, { sc-review-form-button-reject-shortcut } pro rejectar, { sc-review-form-button-skip-shortcut } pro saltar
...
# menu item
review-sentences = Revider phrases
