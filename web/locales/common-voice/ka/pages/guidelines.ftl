...
what-makes-a-good-question-explanation-criteria-3 = არ შეიცავდეს და არ საჭიროებდეს მავნე ან შეურაცხმყოფელ სიტყვებს
...
offensive-content-sensitive-information-explanation-explanation-2 = კითხვები, რომლებიც შეიძლება იწვევდეს სიძულვილით სავსე ან სხვა მიკერძოებულ თუ შეურაცხმყოფელ განწყობილებას
...
transcribe-the-audio-subheader-1-explanation = საერთოდ, ყველაფერი უნდა გადმოიცეს წერილობით, რასაც კი გაიგონებთ. მათ შორის;
transcribe-the-audio-subheader-1-explanation-example-1 = სრულად დაიწეროს ისეთი დარღვევა, როგორიცაა ბორძიკი ან გამეორება
transcribe-the-audio-subheader-1-explanation-example-2 = მოინიშნოს ხმაურის შემთხვევები, როგორიცაა ხველა ან გაცინება
transcribe-the-audio-subheader-1-explanation-example-3 = მოინიშნოს მნიშვნელოვნად შემოჭრილი ხმაური, როგორიცაა ფონური ყაყანი ან მანქანის საყვირი
...
transcribe-the-audio-subheader-2-example-2-correct = <correct> მართებული</correct>: შევხვდებით <underline>ორი ათას თხუთმეტში</underline>
...
special-tags-example-2 =
    და შემდეგ [noise] გავედი შვებულებაში.
    კარგი, ჰო, [noise] [laugh] მთლად შვებულებაც არ ყოფილა [laugh]
transcribe-the-audio-subheader-4-explanation-1 = ზეპირ მეტყველებას ბუნებრივად ახლავს მცდარი დაწყება საუბრისას, როცა სიტყვა მხოლოდ ნაწილობრივ ითქმის. ასეთ შემთხვევებში გთხოვთ, მეტად ეცადოთ, ჩაწეროთ სიტყვის გამოთქმული ნაწილი ბოლოში დეფისის (-) დართვით, რაც თავისთავად მიუთითებს მცდარ დაწყებას. მაგალითად:
transcribe-the-audio-subheader-4-explanation-1-example = მისი სახელია <underline>ივ- ივა-</underline> ივანე.
...
transcribe-the-audio-subheader-4-explanation-2-example = შემდეგ კი გავეშურე <underline>საძინებელ-</underline> საძინებლისკენ
transcribe-the-audio-subheader-5-explanation-1 = ზეპირ მეტყველებას ჩვეულებრივ ახლავს გრამატიკულ შეცდომები. ჩაწერისას არ უნდა გასწორდეს. ნაწერად ქცეული მასალა ზუსტად უნდა ასახავდეს წარმოთქმულს.
...
code-switching = მეტყველების მონაცვლეობა
...
code-switching-adding-question-criteria-3 = არ შეიცავდეს და არ საჭიროებდეს მავნე ან შეურაცხმყოფელ სიტყვებს
...
code-switching-review-criterion-3 = არ შეიცავდეს და არ საჭიროებდეს მავნე ან შეურაცხმყოფელ სიტყვებს
...
code-switching-use-both-languages-example = „როგორც კი დაინახა შორიდან შესძახა – ქუგალე ჯიმა“.
...
code-switching-authentic-direct-quotes-example = „ეჭვი გამოვთქვი მუხბე! – და მეც ავყევი ხითხითში“
code-switching-authentic-reflect = <bold>გადმოეცით გრძნობები, თვითმყოფადობა და გარემოებები.</bold> ენების მონაცვლეობა, ჩვეულებრივ, დამახასიათებელია ხოლმე გრძნობების გამოხატვისას, საგანგებო ვითარებებში და ეროვნული საკითხების მიმართ. ჩაუღრმავდით ამგვარ თემებს კითხვებზე პასუხისას.
...
code-switching-lookalikes-explanation-example-1 = „თუთა“ მეგრულში მთვარეა, ამ მნიშვნელობით გამოყენებისას > მოსანიშნია მეგრული
...
reporting-content = მასალის გასაჩივრება
